<template>
  <section class="bg-gradient-to-b from-gray-900 to-gray-800 min-h-screen py-16 px-4 md:px-6">
        ...
        <ul class="space-y-5 text-gray-800 text-[16px]">
          <li class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500 mt-0.4">學士學位</p>
            </div>
          </li>
          <li class="flex items-start gap-3">
            <div class="pt-[6px]">
            ...
            <div>
              ...
              <p class="text-sm text-gray-500 mt-0.4">碩士學位</p>
            </div>
          </li>
        </ul>
      </div>
